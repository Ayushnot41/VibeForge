    ...
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-[var(--text-secondary)]">Create an account to start simulating.</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-8">
          Already have an account? <Link href="/login" className="text-[var(--accent-purple)] hover:text-white transition-colors">Sign in</Link>
        </p>
      </motion.div>
    </div>
  );

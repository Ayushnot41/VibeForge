    ...
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-white mb-2 tracking-tight">Forge Your Future</h1>
          <p className="text-[var(--text-secondary)] text-sm">
            {step === 'email' ? 'Create your account with live email OTP.' : `Enter the 6-digit code sent to ${email}`}
          </p>
        </div>
        ...
        <p className="text-center text-sm text-gray-400 mt-8">
          Already have an account? <Link href="/login" className="text-[var(--accent-purple)] font-semibold hover:text-white transition-colors">Sign in</Link>
        </p>
      </motion.div>
    </div>
  );
